/* ==========================================================================
   Dither Wave Background — Vanilla WebGL2
   Converted from React/Three.js to raw WebGL for the login page
   ========================================================================== */
...
function createDither(container, options = {}) {
  ...
  // --- Combined Shader: wave generation + dithering in one pass ---
  ...
  const fragSource = `#version 300 es
    ...
    vec3 dither(vec2 fragCoord, vec3 color) {
      ...
      float threshold = bayerMatrix[y * 8 + x] - 0.25;
  ...
  function render(t) {
    ...
    const timeVal = config.disableAnimation ? 0 : t * 0.001;
